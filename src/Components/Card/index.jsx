...
const Card = (data) => {
    ...
    const renderIcon = (id) => {
        ...
        if (isInCart) {
            ...
            return (
                <div 
                className='absolute top-0 right-0 flex justify-center items-center bg-green-900/60 text-white w-6 h-6 rounded-full m-2 p-1'>
            ...
            return (
                <div 
            className='absolute top-0 right-0 flex justify-center items-center bg-amber-900/60 text-white w-6 h-6 rounded-full m-2 p-1'
  ...
  return (
    ...
    onClick={() => showProduct(data.data)}>
        ...
        <p className="flex justify-between">
            <span className="text-sm font-light line-clamp-1 h-5"> {data.data.title} </span>
